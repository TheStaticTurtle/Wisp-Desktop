<template>
	<div class="row" style="background: #313131;padding-bottom: 16px;">
		...
		<div class="col-md-2 col-lg-2 col-xl-2 d-flex flex-column justify-content-center">
			<div v-if="enable_controls" class="row d-flex justify-content-center" style="text-align: center; margin-top: 10px;">
			...
			<div v-if="enable_controls" class="row d-flex justify-content-center" style="text-align: center; margin-top: 0px;">
				<span class="">Speed: {{range_speed_control}}%</span>
			</div>
			<div v-if="enable_controls" class="row" style="margin-bottom: 12px;">
				<div class="col d-flex justify-content-center align-items-center" style="font-size: 20px;text-align: center;margin-bottom: -16px;">
					<a class="text-light" href="#" style="padding-right: 20px;">
